...
console.log = function (text, input) {
    ...
    if (input.evt == 'VOICE_STATE_UPDATE') {
        ...
        id = input.data.user.id; name = input.data.nick; uState = input.data.voice_state;
        for (i = 0; i < spans.length; i++) {
            let attributes = spans[i].attributes['data-reactid'].value
